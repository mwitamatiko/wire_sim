...
import com.example.sim.ui.theme.SimTheme
import com.example.sim.viewmodel.MainViewModel
...
fun TitleRow(head1: String, head2: String, head3: String) {
    Row(
        ...
        Text(head1, color = Color.Black,
            modifier = Modifier
                .weight(0.1f))
        Text(head2, color = Color.Black,
            modifier = Modifier
                .weight(0.2f))
        Text(head3, color = Color.Black,
